...
function DbsOptions (options) {
  ...
  */
  ...
  /**
   * By default, dbs generates github-flavoured markdown. Not all markdown parsers render gfm correctly. If your generated docs look incorrect on sites other than Github (e.g. npmjs.org) try enabling this option to disable Github-specific syntax.
   * @type {boolean}
   */
  this['no-gfm'] = true
  ...
  /**
   * Classname applied to the list
   * @type {string}
   * @default
   */
  this['global-index-class'] = 'nav'
   ...
   * @default
   */
  this['member-index-class'] = 'nav'

  /**
   * Show descendant names in grouped index
   * @type {bool}
   * @default
   */
  this['member-index-details'] = true
  ...
  /**
   * Prefix links with filename
   * @type {boolean}
   * @default false
   */
  this.fileLinkPrefix = false

  /**
   * Basepath to relate filelink prefixes against
   * @type {string}
   * @default CWD
   */
  this.fileLinkBasePath = process.cwd()
